...
I build software for focused work, learning and play.
I'm a software and machine learning engineer. I take projects from the initial
problem through implementation and release.

[Discuss a project](mailto:titas.das+gh@gmail.com) or [suggest a tool](https://implantintelligence.com/request).
...
My work spans software delivery and applied machine learning:

- Document search and question answering for investment research.
- Recommendation systems for fashion, food and entertainment.
- Pricing models for marketplaces.
- Language processing, document extraction and OCR evaluation.
- Sleep biosignal analysis, robotics and embedded systems.

I work across the interface, backend and model. I care about clear behaviour,
useful evaluation and carrying the work through to release.

<details>
<summary>Research and experiments</summary>

- [DocuWise](https://github.com/TitasDas/docuwise-2): PDF question answering and experiments in answer faithfulness.
- [VenueMeter](https://github.com/TitasDas/venuemeter-poc): an Azure prototype for venue sustainability metrics and application testing.

My research background includes machine learning, computer vision, topology
and computational neuroscience.

</details>

<details>
<summary>Outside software</summary>

I paint, cook and enjoy understanding how everyday things work. In grad school,
I built a [robot to chop vegetables](https://sites.google.com/site/jullienor2014/homepage).
I now find cooking and cleaning oddly therapeutic.

Painting also gives me a way to explore how multimodal models interpret images.
...
[Email me](mailto:titas.das+gh@gmail.com) or [describe what you need](https://implantintelligence.com/request).
